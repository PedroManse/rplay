...
def init_deezer_session(deezer_arl):
    global session
    header = {
        "Pragma": "no-cache",
...
def download_song(song, output_file, outid):
    ...
    try:
        ...
        if fh.status_code != 200:
            ...
            # go to https://www.deezer.com/playlist/1180748301
            # search for Moby
            ...
            return output_file
        song_title = song['SNG_TITLE']#.encode("utf-8").decode("ascii", "ignore")
        file_name = f"{output_file}/{song_title}.{outid}.{extension.lower()}"
...
def get_song_infos_from_deezer_website(search_type, id):
    ...
    # id: deezer_id of the song/album/playlist (like https://www.deezer.com/track/823267272)
    ...
    # 1. open playlist https://www.deezer.com/playlist/1180748301 and click on song Honey from Moby in a new tab:
    # 2. Deezer gives you a 404: https://www.deezer.com/track/68925038
    # Deezer403Exception if we are not logged in

    url = "https://www.deezer.com/{}/{}".format(search_type, id)
...
def parse_deezer_playlist(playlist_id):
    ...
    # e.g. https://www.deezer.com/playlist/6046721604 or 6046721604
